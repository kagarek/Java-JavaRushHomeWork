package solved.level28.lesson04.task01;
...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory
    {
        ...
        private AtomicInteger currentThreadNumber = new AtomicInteger(0);
        ...
        {
            currentThreadNumber.incrementAndGet();
            Thread newThread = new Thread(threadGroup,r);
            String name = threadGroup.getName()+"-pool-"+ currentPoolNumber +"-thread-"+currentThreadNumber.toString();
