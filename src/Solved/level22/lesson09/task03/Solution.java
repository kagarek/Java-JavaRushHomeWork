package solved.level22.lesson09.task03;
...
public class Solution {
    public static void main(String[] args) throws IOException
    {
        ...
        BufferedReader file = new BufferedReader(new FileReader(inputReader.readLine()));
        //BufferedReader file = new BufferedReader(new FileReader("resources/level22/level22_lesson09_task03_work.txt"));
        String s = "";
        while(file.ready())
        {
            s = s + " " + file.readLine();
