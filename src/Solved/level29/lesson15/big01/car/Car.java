...
public abstract class Car {
    ...
    public int getNumberOfPassengersCanBeTransferred() { return canPassengersBeTransferred() ? numberOfPassengers : 0; }
    ...
    public boolean isSummer(Date date , Date summerStart, Date summerEnd) { return summerStart.before(date) && summerEnd.after(date); }
    ...
    private boolean canPassengersBeTransferred() { return isDriverAvailable() && fuel > 0; }
