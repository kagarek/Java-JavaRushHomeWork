package solved.level15.lesson02.task05;
...
public class Solution {
    ...
    public static class BodyPart implements Alive {
        ...
        public String toString() {
            return containsBones().equals(new String("Yes")) ? name + " содержит кости" : name + " не содержит кости";
        }
    }
    ...
    public static class Finger extends BodyPart {
        ...
        public Object containsBones() {
            return super.containsBones().equals(new String("Yes")) && !isFoot ? "Yes" : "No";
        }
    }
