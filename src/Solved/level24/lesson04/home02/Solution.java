...
public class Solution implements Action {
    ...
    private Action solutionAction = new Action() {
        ...
        class FirstClassAction extends FirstClass
        {
            public FirstClassAction() {
                super();
            }
            ...
            {
                return new SecondClassAction();
            }
        }

        class SecondClassAction extends SecondClass
        {
            public SecondClassAction() {
                super();
            }

            protected StringBuilder sb = new StringBuilder(super.sb + super.SPECIFIC_ACTION_FOR_ANONYMOUS_SECOND_CLASS_PARAM + param);
        ...
        public void someAction()
        {
            ...
            if (param > 0)
            {
                ...
                FirstClassAction firstClassAction = new FirstClassAction();
                firstClassAction.someAction();
                firstClassAction.getDependantAction().someAction();
            }
            else
                new SecondClassAction().someAction();
        }
    };
