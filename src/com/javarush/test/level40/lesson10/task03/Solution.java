...
public class Solution {
    ...
    public static String weekDayOfBirthday(String birthday, String year) {
        ...
        int addYears = Integer.parseInt(year) - dt.getYear();
        DateTime date = dt.plusYears(addYears);
        return DateTimeFormat.forPattern("EEEE").withLocale(Locale.ITALIAN).print(date);
    }
}
