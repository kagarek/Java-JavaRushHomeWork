package solved.level31.lesson02.home01;
...
public class Solution {
    ...
    public static void main(String[] args) {
        File path = new File(args[0]); // "resources/level31_lesson02_home01/source"
        File resultFileAbsolutePath = new File(args[1]); // "resources/level31_lesson02_home01/result/result.txt"
